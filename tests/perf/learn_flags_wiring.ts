 ...
 * V8 — the memory-sizing helper's fixed FFI/OS headroom constant (#1768). */
...
/**
 * Mirror of the memory-sizing helper's `get_heap_floor_mb`. Hosts below 8 GB keep the global
...
/**
 * Mirror of the memory-sizing helper's `get_max_heap_size`: the `--max-old-space-size` value
