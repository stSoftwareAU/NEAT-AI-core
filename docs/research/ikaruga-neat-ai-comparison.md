...
Source footprint: **~29,700** LOC across `neat-core/src/`, measured September 2026. The figure is indicative only — it is a snapshot for scale, not a tracked invariant. No evolutionary operator code is present — by design.
